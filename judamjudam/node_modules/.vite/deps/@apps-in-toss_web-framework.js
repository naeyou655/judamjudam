...
var requestTossPayPaysBilling = createAsyncBridge("requestTossPayPaysBilling");
var saveBase64Data = createAsyncBridge("saveBase64Data");
var openPDFViewer = createAsyncBridge("openPDFViewer");
var fetchAlbumItems = createAsyncBridge("fetchAlbumItems");
...
var getAnonymousKey = createAsyncBridge("getAnonymousKey");
var getUserKeyForGame = createAsyncBridge("getUserKeyForGame");
var grantPromotionReward = createAsyncBridge("grantPromotionReward");
var grantPromotionRewardForGame = createAsyncBridge("grantPromotionRewardForGame");
var getIsTossLoginIntegratedService = createAsyncBridge("getIsTossLoginIntegratedService");
var getServerTime = createAsyncBridge("getServerTime");
var requestReview = createAsyncBridge("requestReview");
...
var getGroupId = createConstantBridge("getGroupId");
...
var nativeWindow2 = new NativeWindow2();
var createEventId2 = () => Math.random().toString(36).substring(2, 15);
var deserializeError2 = (value) => {
  if (value && value.__isError) {
    const err = new Error(value.message);
    for (const [key, val] of Object.entries(value)) {
      err[key] = val;
...
var _getSafeAreaInsets2 = createConstantBridge2("getSafeAreaInsets");
var SafeAreaInsets = {
...
var deploymentId = createConstantBridge2("deploymentId");
var brandDisplayName = createConstantBridge2("brandDisplayName");
var brandIcon = createConstantBridge2("brandIcon");
var brandPrimaryColor = createConstantBridge2("brandPrimaryColor");
...
var requestPermission2 = createAsyncBridge2("requestPermission");
var getPermission2 = createAsyncBridge2("getPermission");
var openPermissionDialog2 = createAsyncBridge2("openPermissionDialog");
...
var getPermission22 = createAsyncBridge2("getPermission");
var openPermissionDialog22 = createAsyncBridge2("openPermissionDialog");
...
var openURL2 = createAsyncBridge2("openURL");
...
var fetchTossAd = Object.assign(createEventBridge2("fetchTossAd"), {
  isSupported: createConstantBridge2("fetchTossAd_isSupported")
});
var tossAdEventLog = createAsyncBridge2("tossAdEventLog");
...
function initialize(options) {
  ...
  const resolveInitialized = () => {
    var _a;
    return (_a = callbacks == null ? void 0 : callbacks.onInitialized) == null ? void 0 : _a.call(callbacks);
  };
  const rejectInitialized = (error) => {
    var _a;
    const normalizedError = error instanceof Error ? error : new Error(String(error));
    (_a = callbacks == null ? void 0 : callbacks.onInitializationFailed) == null ? void 0 : _a.call(callbacks, normalizedError);
  };
  const existingSdk = getAdsSdk();
  if (existingSdk == null ? void 0 : existingSdk.isInitialized()) {
    resolveInitialized();
    return;
  }
...
function attach(adGroupId, target, options = {}) {
  ...
  const rejectAttached = (error) => {
    var _a;
    const normalizedError = error instanceof Error ? error : new Error(String(error));
    (_a = callbacks == null ? void 0 : callbacks.onAdFailedToRender) == null ? void 0 : _a.call(callbacks, {
      slotId: "",
...
function wrapCallbacks(adGroupId, callbacks) {
  ...
  return {
    onAdRendered: (payload) => {
      var _a;
      return (_a = callbacks.onAdRendered) == null ? void 0 : _a.call(callbacks, mapEvent(payload));
    },
    onAdViewable: (payload) => {
      var _a;
      return (_a = callbacks.onAdViewable) == null ? void 0 : _a.call(callbacks, mapEvent(payload));
    },
    onAdClicked: (payload) => {
      var _a;
      return (_a = callbacks.onAdClicked) == null ? void 0 : _a.call(callbacks, mapEvent(payload));
    },
    onAdImpression: (payload) => {
      ...
      tossAdEventLog({
        ...
        params: {
          ...
          schema_id: 1812034,
          request_id: ((_a = payload == null ? void 0 : payload.adMetadata) == null ? void 0 : _a.requestId) ?? ""
        }
      });
      (_b = callbacks.onAdImpression) == null ? void 0 : _b.call(callbacks, mapEvent(payload));
    },
    onAdFailedToRender: (payload) => {
      var _a;
      return (_a = callbacks.onAdFailedToRender) == null ? void 0 : _a.call(callbacks, {
        ...mapEvent(payload),
        error: (payload == null ? void 0 : payload.error) ?? { code: 0, message: "UNKNOWN" }
      });
    },
    onNoFill: (payload) => {
      var _a;
      return (_a = callbacks.onNoFill) == null ? void 0 : _a.call(callbacks, mapEvent(payload));
    }
  };
}
var TossAds = {
...
var getServerTime2 = Object.assign(createAsyncBridge2("getServerTime"), {
  isSupported: createConstantBridge2("getServerTime_isSupported")
});
var requestReview2 = Object.assign(createAsyncBridge2("requestReview"), {
  isSupported: createConstantBridge2("requestReview_isSupported")
});
function requestNotificationAgreement(params) {
  const { options, onEvent, onError } = params;
  const unregisterCallbacks = createEventBridge2("requestNotificationAgreement")({
    options,
    onEvent: (result) => {
      onEvent(result);
    },
...
export {
  ...
  closeView,
  contactsViral,
  createAsyncBridge2 as createAsyncBridge,
  createConstantBridge2 as createConstantBridge,
  createEventBridge2 as createEventBridge,
  env,
  eventLog,
  fetchAlbumItems,
  fetchAlbumPhotos2 as fetchAlbumPhotos,
  fetchContacts2 as fetchContacts,
  generateHapticFeedback,
  getAnonymousKey,
  getAppsInTossGlobals,
  getClipboardText2 as getClipboardText,
  getCurrentLocation2 as getCurrentLocation,
  getDeviceId,
  ...
  getSafeAreaInsets,
  getSchemeUri,
  getServerTime2 as getServerTime,
  getTossAppVersion,
  getTossShareLink,
  getUserKeyForGame,
  graniteEvent,
  ...
  requestPermission,
  requestReview2 as requestReview,
  requestTossPayPaysBilling,
  saveBase64Data,
  setClipboardText2 as setClipboardText,
  ...
  share,
  showFullScreenAd,
  startUpdateLocation2 as startUpdateLocation,
  submitGameCenterLeaderBoardScore,
  tdsEvent
};
//# sourceMappingURL=@apps-in-toss_web-framework.js.map
